# this_file: src/vexy_dexypy/dom.py
...
def wrap_neutral(sections: list[Tag], head_nodes: list[Tag] | None = None) -> str:
    """Wrap a list of <section> slides in a framework-neutral HTML template.

    Instead of .reveal > .slides wrapping, it simply places the flat list of
